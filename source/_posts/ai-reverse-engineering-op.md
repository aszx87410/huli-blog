...
tags: [Security]
categories: [Security]
photos: /img/ai-reverse-engineering-op/cover.png
---
...
雖然說我原本就知道 AI 強，但其實沒想到已經強到這種地步。如同我以前[寫過的](https://blog.huli.tw/2023/04/27/android-apk-decompile-intro-1/)，逆向工程我會一點點皮毛，但到了 native 那一層就完全不行了，而 AI 已經超越了我的能力，做出了那些我做不到的事，甚至做出了「我以為他做不到」的事。
...
有沒有什麼是 AI 解不開的？或許有，像我上面提的案例七其實就沒解開，他只是換個方式拿到我想要的東西，並沒有把 APP 全部都還原。但除了這個以外，他每一個都確實解開了（話說我很好奇 AI 能不能解開 HybridCLR 的[商業殼](https://www.hybridclr.cn/docs/business/basicencryption)，但我還沒碰過用這個商業版本的）。
